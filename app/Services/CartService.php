    ...
    public function mini_cart_markup($products) {
        ...
        foreach($products as $product) {
            ...
            if($product->thumbnail) {
                ...
                $thumbnail = asset('assets/frontend/img/p1.jpg');
            }
            ...
            <img src="'. asset($thumbnail) .'" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="'. $product->title .'"></a>
            <div class="mini_cart_item-desc">
                ...
                <span class="quantity">'. CartController::get_cart()[$product->id]['qty'] .' × <span class="woocs_special_price_code"><span class="woocommerce-Price-amount amount">'. $product->finalPrice() .'<span class="woocommerce-Price-currencySymbol">$</span></span></span></span>
            </div>
        </li>';
        }
        if(count($products) > 0) {
            $data .= '<li class="woocommerce-mini-cart-item mini_cart_item">
                <div class="woocomerce-mini-cart__container">
                    ...
                    <p class="woocommerce-mini-cart__buttons buttons">
                        ...
                        <a href="'. route('frontend.checkout') .'" class="button checkout wc-forward">Checkout</a>
                    </p>
                </div>
            </li>';
        } else {
