                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="address_line_1" id="address_line_1" class="form-control" value="{{ old('address_line_1') ? old('address_line_1') : $orderDetails->address_line_1 }}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="address_line_2" id="address_line_2" class="form-control" value="{{ old('address_line_2') ? old('address_line_2') : $orderDetails->address_line_2 }}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="city" id="city" class="form-control" value="{{ old('city') ? old('city') : $orderDetails->city }}">
                                                                            @error('city')
                                                                                <span class="text-danger">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="state" id="state" class="form-control" value="{{ old('state') ? old('state') : $orderDetails->state }}">
                                                                            @error('state')
                                                                                <span class="text-danger">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="zip" id="zip" class="form-control" value="{{ old('zip') ? old('zip') : $orderDetails->zip }}">
                                                                            @error('zip')
                                                                                <span class="text-danger">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-12">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="different_shipping" id="different_shipping" class="form-check-input">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="s_address_line_1" id="s_address_line_1" class="form-control" value="{{ old('s_address_line_1') ? old('s_address_line_1') : $orderDetails->s_address_line_1 }}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="s_address_line_2" id="s_address_line_2" class="form-control" value="{{ old('s_address_line_2') ? old('s_address_line_2') : $orderDetails->s_address_line_2 }}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="s_city" id="s_city" class="form-control" value="{{ old('s_city') ? old('s_city') : $orderDetails->s_city }}">
                                                                            @error('s_city')
                                                                                <span class="text-danger">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="s_state" id="s_state" class="form-control" value="{{ old('s_state') ? old('s_state') : $orderDetails->s_state }}">
                                                                            @error('s_state')
                                                                                <span class="text-danger">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="s_zip" id="s_zip" class="form-control" value="{{ old('s_zip') ? old('s_zip') : $orderDetails->s_zip }}">
                                                                            @error('s_zip')
                                                                                <span class="text-danger">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                    ...
                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                        ...
                                                        <tbody>
                                                            <tr class="cart-subtotal">
                                                                <th>Subtotal</th>
                                                                <td><strong class="sub-total">$ <span class="price">{{ CartController::sub_total() }}</span></strong></td>
                                                            </tr>
                                                            <tr class="cart_item">
                                                        ...
                                                        <tr class="order-total">
                                                            <th>Total</th>
                                                            <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$ </span>{{ CartController::cart_final_price() }}</span></strong> </td>
                                                        </tr>
                                                        </tfoot>
                                                    </table>
                                                            ...
                                                            <div class="card-body">
                                                                <ul class="wc_payment_methods payment_methods methods">
                                                                    <li class="wc_payment_method payment_method_cod">
                                                                        <input id="payment_method_cod" type="radio" class="input-radio payment_method_selector d-none" name="payment_method" value="cod" checked="checked">
        
                                                                        <label for="payment_method_cod">
                                                                            Cash on delivery 	</label>
                                                                        <div class="payment_box payment_box_collapse payment_method_cod">
                                                                            <p>Pay with cash upon delivery.</p>
                                                                        </div>
                                                                    </li>
                                                                    <li class="wc_payment_method payment_method_bkash">
                                                                        <input id="payment_method_bkash" type="radio" class="input-radio payment_method_selector  d-none" name="payment_method" value="bkash">
        
                                                                        <label for="payment_method_bkash">bKash</label>
                                                                        <div class="payment_box payment_box_collapse payment_method_bkash">
                                                                            <p>Pay with bKash.</p>
                                                                        </div>
                                                                    </li>
                                                                </ul>
